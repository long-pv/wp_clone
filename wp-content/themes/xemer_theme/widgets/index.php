...
{
    // include file
    require_once get_template_directory() . '/widgets/template/header.php';
    require_once get_template_directory() . '/widgets/template/duplicate_widget.php';
    require_once get_template_directory() . '/widgets/template/archive_posts.php';
    require_once get_template_directory() . '/widgets/template/slider_slick.php';
    require_once get_template_directory() . '/widgets/template/widget_table.php';
