...
{
	wp_enqueue_style('xemer_theme-style-vendor', get_template_directory_uri() . '/dist/assets/css/vendor.css', array(), _S_VERSION);
	wp_enqueue_script('xemer_theme-script-vendor', get_template_directory_uri() . '/dist/assets/js/vendor.js', array('jquery'), _S_VERSION, true);

	//add custom main css/js
	$main_css_file_path = get_template_directory() . '/dist/assets/css/main.css';
	$main_js_file_path = get_template_directory() . '/dist/assets/js/main.js';
	...
	wp_enqueue_style('xemer_theme-style-main', get_template_directory_uri() . '/dist/assets/css/main.css', array(), $ver_main_css);
	wp_enqueue_script('xemer_theme-script-main', get_template_directory_uri() . '/dist/assets/js/main.js', array('jquery'), $ver_main_js, true);
}
