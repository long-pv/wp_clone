...
function xemer_theme_scripts() {
	...
	wp_style_add_data( 'xemer_theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'xemer_theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
